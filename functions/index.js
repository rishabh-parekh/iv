...
exports.sendEmailConfirmation = functions.database.ref('/Illuminate/saveinfo/{userid}').onCreate(event => {
  ...
  mailOptions.text = 'Thanks you for subscribing to our newsletter.';
